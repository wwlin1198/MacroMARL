...
class Learner(object):
    ...
    def train(self, eps, ippo_clip_value, ippo_epochs):
        ...
        state, reward, n_state, terminate, mac_v_b, discount, exp_valid = cen_batch
        ...
        for _ in range(ippo_epochs):
            ...
            Gt = self._get_discounted_return(reward, n_state,
                                                discount,
                                                terminate, 
                                                cen_epi_len, 
            ...
            V_value = agent.critic_net(state)[0]
            ...
            for t in reversed(range(len(delta))):
                if t == len(delta) - 1:
                    ...
                    adv_values[t] = delta[t] + self.gamma * self.lambda_gae * adv_values[t + 1]
    ...
    def _sep_joint_exps(self, joint_exps):
        ...
        for s, o, a_st, avail_a, a, r, j_r, n_s, n_o, n_avail_a, t, mac_v, j_max_v, exp_v in chain(*joint_exps):
    ...
    def _squeeze_dec_exp(self, dec_batches, batch_size, trace_len, adv_value, j_padded_mac_v_b):
        ...
        for idx, batch in enumerate(dec_batches):
            ...
            obs_b, action_b, mac_valid_b, exp_valid_b = zip(*batch)
